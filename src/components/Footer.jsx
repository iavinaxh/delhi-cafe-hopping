    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-[#E7B894]">
        ...
        <div>
          ...
          <div className="space-y-2 text-xs"><p className="text-[#4E382E]">Curated by <strong className="text-[#7A2E12]">Avinash</strong></p><button onClick={onOpenInstaModal} className="px-3.5 py-2 rounded-xl bg-[#CC3A63] text-white font-semibold text-xs inline-flex items-center gap-2 hover:bg-[#B52F55] transition-all"><InstagramIcon className="w-4 h-4"/><span>@iavinaxh on Instagram</span><QrCode className="w-3.5 h-3.5 opacity-80"/></button></div>
        </div>
        <div>
          <h4 className="text-xs uppercase font-bold tracking-wider text-[#CC3A63] mb-3">Built for better decisions</h4>
          <p className="text-xs text-[#6D5143] mb-2 leading-relaxed">OpenStreetMap powers live place discovery; the curated guide and optional AI layer help narrow the choices without pretending uncertain facts are certain.</p>
