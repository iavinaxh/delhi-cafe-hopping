...
export default function RecommendationPlanner({cafes=[]}){
  ...
  return <section id="find-my-place" className="bg-[#F47B3A] px-4 sm:px-6 lg:px-8 py-12 sm:py-16"><div className="max-w-6xl mx-auto"><div className="max-w-3xl mb-8"><div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-[#FFF4E6]/85 mb-3"><Sparkles className="w-4 h-4"/> Personalized restaurant finder</div><h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#3A1F14]">Tell us what you want. We'll pick the places.</h2><p className="mt-3 text-sm sm:text-base text-[#FFF4E6]/90 leading-relaxed">Choose a fixed Delhi NCR area, your total budget, group size and mood. Recommendations come only from our manually curated restaurant and cafe catalogue.</p></div>
    <form onSubmit={findPlaces} className="rounded-[30px] bg-[#FFF4E6] border border-[#E7B894] p-4 sm:p-7 shadow-[0_20px_55px_rgba(89,37,15,0.20)]"><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-5 lg:gap-y-4 items-end">
      <label className="lg:col-span-2 block"><span className="block min-h-[18px] text-xs font-bold uppercase tracking-wider text-[#7A2E12]">Where?</span><div className="relative mt-2"><MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#F47B3A] pointer-events-none"/><select value={form.location} onChange={e=>update('location',e.target.value)} className="w-full h-12 pl-10 pr-10 rounded-xl bg-white/75 border border-[#E7B894] outline-none focus:ring-2 focus:ring-[#F47B3A]/25 focus:border-[#F47B3A] appearance-none shadow-[0_5px_14px_rgba(89,37,15,0.06)] transition-shadow hover:shadow-[0_7px_18px_rgba(89,37,15,0.09)]"><option value="All Delhi NCR">All Delhi NCR</option>{LOCATION_OPTIONS.filter(x=>x!=='All Delhi NCR').map(x=><option key={x} value={x}>{x}</option>)}</select></div></label>
      <label className="block"><span className="block min-h-[18px] text-xs font-bold uppercase tracking-wider text-[#7A2E12]">Budget target</span><div className="relative mt-2"><Wallet className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#F47B3A] pointer-events-none"/><select value={form.budget} onChange={e=>update('budget',e.target.value)} className="w-full h-12 pl-10 pr-8 rounded-xl bg-white/75 border border-[#E7B894] outline-none focus:ring-2 focus:ring-[#F47B3A]/25 focus:border-[#F47B3A] appearance-none shadow-[0_5px_14px_rgba(89,37,15,0.06)] transition-shadow hover:shadow-[0_7px_18px_rgba(89,37,15,0.09)]"><option value="700">₹700</option><option value="1000">₹1,000</option><option value="1500">₹1,500</option><option value="2000">₹2,000</option><option value="3000">₹3,000+</option></select></div></label>
      <label className="block"><span className="block min-h-[18px] text-xs font-bold uppercase tracking-wider text-[#7A2E12]">People</span><div className="relative mt-2"><Users className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#F47B3A] pointer-events-none"/><select value={form.people} onChange={e=>update('people',e.target.value)} className="w-full h-12 pl-10 pr-8 rounded-xl bg-white/75 border border-[#E7B894] outline-none focus:ring-2 focus:ring-[#F47B3A]/25 focus:border-[#F47B3A] appearance-none shadow-[0_5px_14px_rgba(89,37,15,0.06)] transition-shadow hover:shadow-[0_7px_18px_rgba(89,37,15,0.09)]"><option value="1">1 person</option><option value="2">2 people</option><option value="3">3 people</option><option value="4">4 people</option><option value="6">5–6 people</option><option value="8">7–8 people</option><option value="10">9–10 people</option></select></div></label>
      <label className="block"><span className="block min-h-[18px] text-xs font-bold uppercase tracking-wider text-[#7A2E12]">Vibe</span><div className="relative mt-2"><select value={form.vibe} onChange={e=>update('vibe',e.target.value)} className="w-full h-12 px-3 pr-8 rounded-xl bg-white/75 border border-[#E7B894] outline-none focus:ring-2 focus:ring-[#F47B3A]/25 focus:border-[#F47B3A] appearance-none shadow-[0_5px_14px_rgba(89,37,15,0.06)] transition-shadow hover:shadow-[0_7px_18px_rgba(89,37,15,0.09)]"><option>Any vibe</option><option>Romantic</option><option>Quiet</option><option>Aesthetic</option><option>Casual</option><option>Youthful</option><option>Rooftop</option><option>Outdoor</option><option>Lively</option></select></div></label>
      <div className="lg:col-span-2 min-h-[88px] rounded-2xl bg-[#FCE6D0] border border-[#E7B894] p-3.5 sm:p-4 flex items-center gap-4 shadow-[0_8px_22px_rgba(89,37,15,0.08)]"><div className="shrink-0 w-10 h-10 rounded-xl bg-[#F47B3A]/15 flex items-center justify-center shadow-sm"><Calculator className="w-5 h-5 text-[#F47B3A]"/></div><div className="min-w-0"><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#7A2E12]">Your budget plan</p><p className="text-sm sm:text-base font-bold text-[#3A1F14] mt-0.5">{formatMoney(selectedBudget)} total for {people} {people===1?'person':'people'} <span className="font-normal text-[#806050]">• {formatMoney(budgetPerPerson)} per person</span></p><p className="text-xs text-[#806050] mt-1 leading-relaxed">Venue prices in this guide are listed for 2 people. We scale the estimate automatically when your group size changes.</p></div></div>
      <div className="lg:col-span-1 h-12"><button type="submit" className="w-full h-12 rounded-full bg-[#F47B3A] text-white font-bold flex items-center justify-center gap-2 hover:bg-[#D9682D] hover:-translate-y-0.5 shadow-[0_8px_20px_rgba(89,37,15,0.18)] hover:shadow-[0_11px_24px_rgba(89,37,15,0.24)] transition-all"><Search className="w-5 h-5"/>Find My Places</button></div>
    </div></form>
