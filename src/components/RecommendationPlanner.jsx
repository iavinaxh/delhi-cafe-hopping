  ...
  return <section id="find-my-place" className="bg-[#F47B3A] px-4 sm:px-6 lg:px-8 py-12 sm:py-16"><div className="max-w-6xl mx-auto"><div className="max-w-3xl mb-8"><div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-[#FFF4E6]/85 mb-3"><Sparkles className="w-4 h-4"/> Personalized restaurant finder</div><h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#3A1F14]">Tell us what you want. We'll pick the places.</h2><p className="mt-3 text-sm sm:text-base text-[#FFF4E6]/90 leading-relaxed">Choose a fixed Delhi NCR area, your total budget, group size and mood. Recommendations come only from our manually curated restaurant and cafe catalogue.</p></div>
    <form onSubmit={findPlaces} className="rounded-[30px] bg-[#FFF4E6] border border-[#E7B894] p-4 sm:p-7 shadow-[0_20px_55px_rgba(89,37,15,0.20)]">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-5 md:gap-y-4 items-start">
        ...
        <div className="md:col-span-8 block self-start">
          <button type="submit" className="w-full h-12 rounded-full bg-[#F47B3A] text-white font-bold flex items-center justify-center gap-2 border-2 border-[#F47B3A] shadow-[0_10px_24px_rgba(89,37,15,0.22)] hover:bg-[#D9682D] hover:border-[#D9682D] hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(89,37,15,0.28)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#7A2E12]/25 active:translate-y-0 active:scale-[0.99] transition-all"><Search className="w-5 h-5"/><span>Find My Places</span></button>
        </div>
        <label className="md:col-span-4 block">
          <span className="block min-h-[18px] text-xs font-bold uppercase tracking-wider text-[#7A2E12]">Vibe</span>
          <div className="relative mt-2"><select value={form.vibe} onChange={e=>update('vibe',e.target.value)} className={`${selectClass} px-3 pr-10`}><option>Any vibe</option><option>Romantic</option><option>Quiet</option><option>Aesthetic</option><option>Casual</option><option>Youthful</option><option>Rooftop</option><option>Outdoor</option><option>Lively</option></select><SelectArrow/></div>
        </label>

        <div className="md:col-span-12 min-h-[88px] rounded-2xl bg-[#FCE6D0] border border-[#E7B894] p-3.5 sm:p-4 flex items-center gap-4 shadow-[0_8px_22px_rgba(89,37,15,0.08)]">
          <div className="shrink-0 w-10 h-10 rounded-xl bg-[#F47B3A]/15 flex items-center justify-center shadow-sm"><Calculator className="w-5 h-5 text-[#F47B3A]"/></div>
          <div className="min-w-0"><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#7A2E12]">Your budget plan</p><p className="text-sm sm:text-base font-bold text-[#3A1F14] mt-0.5">{formatMoney(selectedBudget)} total for {people} {people===1?'person':'people'} <span className="font-normal text-[#806050]">• {formatMoney(budgetPerPerson)} per person</span></p><p className="text-xs text-[#806050] mt-1 leading-relaxed">Venue prices in this guide are listed for 2 people. We scale the estimate automatically when your group size changes.</p></div>
        </div>
      </div>
    </form>
