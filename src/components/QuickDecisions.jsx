...
import { Zap, Sun, Moon, DollarSign, Compass, Utensils, Coffee } from 'lucide-react';
...
export default function QuickDecisions({ cafes, onSelectCafe }) {
  const picks = [
    ...
    ['Proper CP Dinner','Cafe Sandoz + CP Walk','₹800–₹1,000','cafe-sandoz',Utensils],
  ...
  return <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-[#CC3A63]">
    <div className="flex items-center gap-3 mb-6">
      ...
      <div><h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#241F1A]">10-Second Decision</h2><p className="text-sm text-[#F9F0E0]">Pick by date mood and budget.</p></div>
    </div>
    ...
    <div className="mt-8 p-5 rounded-2xl bg-[#FFF7EB] border border-[#A2AB73]/60 text-[#4E453B] text-sm"><b className="text-[#CC3A63]">Budget rule:</b> keep ₹200–₹300 buffer for tax, an extra drink, dessert or the last-mile auto/cab.</div>
  </section>;
}
